  ...
  return (
    <div>
      <div className="ml-10 right-0 w-full md:w-2/3">
        <h1 className="text-customMaroon mx-10 text-4xl md:text-7xl font-bold leading-snug tracking-normal text-shadow-md">Medical Team Information</h1>
        ...
        <form>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full md:w-3/4 px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500"
              required
            />
          </div>
          ...
          {members.map((member, index) => (
            <div key={index} className="flex flex-col md:flex-row items-center space-y-4 md:space-x-4 md:space-y-0 my-4">
          ...
          {volunteers.map((volunteer, index) => (
            <div key={index} className="flex flex-col md:flex-row items-center space-y-4 md:space-x-4 md:space-y-0 mb-4">
