    ...
    <div>
      <div className="ml-10 right-0 w-full md:w-2/3">
        ...
        <h1 className="text-black mx-10 font-semibold text-base md:text-xl">
          Safety measures and proper guidelines to follow during the donation camp
        </h1>
      </div>
      ...
      <form className="p-6 mt-6 mx-4">
        {[
          ...
          'Protocols for emergencies/adverse reactions?',
          'Do you have necessary permits and approvals from relevant authorities?',
        ].map((question, index) => (
          <div key={index} className="flex items-center justify-between p-2 mb-4 flex-wrap">
            <label className="font-medium text-customTextColor w-full md:w-2/3">
              {question}
            </label>
            <div className="flex space-x-6 w-full md:w-1/3 justify-start md:justify-end">
              <div className="flex items-center">
                ...
                />
                <label htmlFor={`yes-${index}`} className="mx-2 text-customTextColor">
                  Yes
                </label>
              </div>
              <div className="flex items-center">
                ...
                />
                <label htmlFor={`no-${index}`} className="ml-2 text-customTextColor">
                  No
                </label>
              </div>
            </div>
